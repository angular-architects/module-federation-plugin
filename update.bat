...
call npm i softarc-native-federation-0.9.1.tgz

call npm uninstall angular-architects-native-federation-runtime-0.9.1.tgz
call nx build native-federation-runtime
call npm pack dist\libs\native-federation-runtime
call npm i angular-architects-native-federation-runtime-0.9.1.tgz

call npm uninstall angular-architects-native-federation-0.9.1.tgz
call nx build native-federation
call npm pack dist\libs\native-federation
call npm i angular-architects-native-federation-0.9.1.tgz