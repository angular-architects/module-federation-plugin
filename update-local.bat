call npm unpublish @softarc/native-federation@1.1.1-beta.0 --registry http://localhost:4873
call npm unpublish @softarc/native-federation-runtime@1.1.1-beta.0 --registry http://localhost:4873
call npm unpublish @softarc/native-federation-esbuild@1.1.1-beta.0 --registry http://localhost:4873
call npm unpublish @angular-architects/native-federation@1.1.1-beta.0 --registry http://localhost:4873
